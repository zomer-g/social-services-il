...
export function DevelopersPage() {
  return (
    <div className="devdocs">
      ...
      <h2 id="client">האתר עצמו כלקוח MCP</h2>
      <p>
        חוץ מלפרסם שרת MCP, האתר גם <strong>צורך</strong> שרתי MCP. בממשק הניהול אפשר לרשום כתובת של
        שרת MCP חיצוני, והחיפוש באתר יגלה את הכלים שלו בזמן אמת — בלי לכתוב אינטגרציה ובלי פריסה
        מחדש. זו הסיבה שהפרוטוקול קיים: השרת מתאר את עצמו.
      </p>
      <p>
        השרת של האתר עצמו רשום שם גם הוא. לפנות אליו דרך הפרוטוקול במקום לקרוא לאותן פונקציות
        ישירות לא משפר את התוצאה — אלה אותם כלים בדרך ארוכה יותר — והוא רשום כדי שהמאגר המקומי
        ומאגר חיצוני ייבדקו באותו מנגנון בדיוק, וכדי שהאתר יהיה לקוח אמיתי של החוזה שהוא מפרסם.
      </p>
      <p>
        התועלת האמיתית מגיעה עם המקור השני. לדוגמה: במאגר יש 2,534 ארגונים עם מספר עמותה, ואין לנו
        דרך לדעת אם עמותה נמחקה מהרשם — שירות של עמותה שאינה קיימת עוד הוא תשובה שגויה שאיננו
        מזהים. שרת MCP של מרשם העמותות יודע לענות על זה.
      </p>
